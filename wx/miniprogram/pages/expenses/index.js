...
Page({
  ...
  formatDate(list) {
    ...
    return list.map(item=>{
      let category = categoryList.find(categoryItem=>categoryItem.id==item.expenses_category)
      item.category = category.category_name
      let handler = handlerList.find(handlerItem=>handlerItem.id==item.expenses_handler)
