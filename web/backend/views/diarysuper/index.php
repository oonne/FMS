    ...
    <div class="col-lg-12">
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'diary_content',
                    'headerOptions' => ['class' => 'col-md-6'],
                    'filterInputOptions' => ['class' => 'form-control input-sm'],
                    'value' => function ($model, $key, $index, $column) {
                        $preview = strip_tags($model->diary_content);
                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'delete' => function ($url, $model, $key) {
                            return Html::a('删除', ['delete-diary', 'id' => $key], ['class' => 'btn btn-danger btn-xs', 'data-confirm' => Yii::t('yii', '确定删除“'.$model->diary_date.'”吗？')]);
                        },
                    ]
                ]
            ]
