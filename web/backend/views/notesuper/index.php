...
<p>
    <?= Html::a('添加记录', ['notesuper/add-note'], ['class' => 'btn btn-success']) ?>
</p>
<div class="row">
    <div class="col-lg-12">
    ...
    <div class="col-lg-12">
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'attribute' => 'note_content',
                    'headerOptions' => ['class' => 'col-md-4'],
                    'filterInputOptions' => ['class' => 'form-control input-sm'],
                    'value' => function ($model, $key, $index, $column) {
                        $preview = strip_tags($model->note_content);
                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'update' => function ($url, $model, $key) {
                            return Html::a('修改', ['update-note', 'id' => $key], ['class' => 'btn btn-warning btn-xs']);
                        },
                        'delete' => function ($url, $model, $key) {
                            return Html::a('删除', ['delete-note', 'id' => $key], ['class' => 'btn btn-danger btn-xs', 'data-confirm' => Yii::t('yii', '确定删除“'.$model->note_title.'”吗？')]);
                        },
                    ]
                ]
            ]
